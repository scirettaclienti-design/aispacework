                    ...
                    <div className="relative z-10 w-full h-full p-6 md:p-12 xl:p-16 flex flex-col pointer-events-none max-w-[1400px] mx-auto">
                        ...
                        <div className="flex justify-between items-start w-full pointer-events-auto shrink-0 mb-8 border-b border-white/5 pb-6">
                            <div>
                                ...
                                <h1 className="text-3xl md:text-5xl font-display font-medium uppercase tracking-tighter drop-shadow-2xl leading-none text-white">
                                    {activeNode ? (
                                        <div className="flex items-center gap-4">
                                            <span className="text-white/40 font-light">LOCK:</span> 
                                            <span className={`${activeNode.colors.text} drop-shadow-[0_0_20px_currentColor]`}>{activeNode.title}</span>
                                        </div>
                                    ) : (
